...
public class TestSocket extends AppCompatActivity {
    ...
    private final String TURNONRELAY = "turn on relay";
    private final String BEGINFUEL = "begin fueling";
    private final String PULSORCOUNT = "quantity";
    private final String TURNOFFRELAY = "turn off relay";
    private final String GETHISTORY = "record check";
    private final String TAG = "TestSocket...";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSocketOn = findViewById(R.id.btnSocketOn);
        btnSocketOff = findViewById(R.id.btnSocketOff);
        btnturnonrelay = findViewById(R.id.btnturnonrelay);
        btnbeginfueling = findViewById(R.id.btnbeginfueling);
        btnquantity = findViewById(R.id.btnquantity);
        btnturnoffrelay = findViewById(R.id.btnturnoffrelay);
        btnrecordcheck = findViewById(R.id.btnrecordcheck);
