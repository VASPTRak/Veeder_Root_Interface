...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*  SW: Huh? we don't want wifi on.  We want mobile data to be on, and wifi off.
        if (wifiManager.isWifiEnabled() == true) {
            ...
            alertDialog.setMessage("Please check and enable wifi");
    ...
    class WifiReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context c, Intent intent) {
            ...
            for (int i = 0; i < wifiList.size(); i++) {
                ...
                providerName = (wifiList.get(i).SSID);
    ...
    public class GetSitListAsynTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                //----------------------------------------------------------------------------------
                String authString = "Basic " + AppConstants.convertStingToBase64(AppConstants.getOriginalUUID_IMEIFromFile(MainActivity.this) + ":" + Email + ":" + "AndroidSSID");
    ...
    public class ConnectWifiTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (!selectedSSID.contains(connetedSSID)) {
                ...
                int netId = wifiManager != null ? wifiManager.addNetwork(wifiConfiguration) : 0;
