...
public class BackgroundService extends Service {
    ...
    final DBController controller = new DBController(BackgroundService.this);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (StatusData != null && StatusData.size() > 0) {
            ...
            CommonUtils.LogMessage("", " getAllUpdateTranStatus count: " + StatusData.size(), null);
        ...
        if (uData != null && uData.size() > 0) {
            ...
            CommonUtils.LogMessage("", " getAllTransaction count: " + uData.size(), null);
        ...
        protected void onPostExecute(String resp) {
            ...
            try {
                ...
                if (ResponceMessage.equalsIgnoreCase("success") || ResponceMessage.equalsIgnoreCase("fail")) {
                    ...
                    CommonUtils.LogMessage("", " deleteTransactions: id="+Id, null);
                }
