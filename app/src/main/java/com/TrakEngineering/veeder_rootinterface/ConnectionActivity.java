...
public class ConnectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvClientMsg = findViewById(R.id.textViewClientMessage);
    ...
    public void sendMessage(View view) {
        try {
            ...
            if (comment != null) {
                new ServerConnectionTask(SERVER_IP, SERVER_PORT, tvClientMsg, comment).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, (Void[]) null);
    ...
    public class ServerConnectionTask extends AsyncTask<Void, Void, String> {
        ...
        final String TAG = "ServerConneTask";
        final String dstAddress;
        final int dstPort;
        final TextView textResponse;
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                ...
                if (command != null) {
                    ...
                    DataOut.write(command.getBytes(StandardCharsets.US_ASCII));
                    DataOut.flush();
