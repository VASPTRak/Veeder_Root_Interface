                    ...
                    try {
                        ...
                        if (value[value.length - 1] == Constants.ETX) {
                            if (ValidChecksum(response_message)) {
                                ...
                                Process_all_response(response_message);
                            } else {
            ...
            if (c != null) {
                ...
                if (pm != null) {
                    ...
                    if (mStartActivity != null) {
                        ...
                        Log.e(TAG, "Unable to restart application, mStartActivity null");
                    }
                } else {
                    Log.e(TAG, "Unable to restart application, PM null");
                }
            } else {
                Log.e(TAG, "Unable to restart application, Context null");
            }
        } catch (Exception ex) {
            CommonUtils.LogMessage(TAG, "VR_interface: doRestart Exception: ", ex);
        }
    }
...
/*
    ...
    private String make_VR_command2(String Command_code, int TankNo) { //computer code response
        ...
        try {
            ...
            String TankString = myFormatter.format(TankNo);
            String SecurityCode = "";
            Command_String = (char) Constants.SOH + "i" + SecurityCode + Command_code + TankString; // "i"  +
            System.out.println("sending command " + Command_String);
            CommonUtils.LogMessage(TAG, "Sending command: " + Command_String);
        } catch (Exception ex) {
            CommonUtils.LogMessage(TAG, "VR_interface: make_VR_command2 Exception: ", ex);
        }
        return Command_String;
    }
        ...
        try {
            ...
            switch (CommandCode) {
                case "i" + Constants.VR_Inventory_Code: //It is sending the inventory report
                    ...
                    CommonUtils.LogMessage(TAG, "parse_VR_Inventory_response: DateTime-" + DateTime, null);
                ...
                case "i" + Constants.VR_Delivery_Code: //It is sending the inventory report
                    ...
                    CommonUtils.LogMessage(TAG, "parse_VR_Delivery_response: DateTime-" + DateTime_dc, null);
                ...
                case "i" + Constants.VR_Leak_Code: //It is sending the leak report
                    ...
                    CommonUtils.LogMessage(TAG, "parse_VR_Leak_response: DateTime-" + DateTime_lc, null);
            ...
            CommonUtils.LogMessage(TAG, "VR_interface: parse_VR_response Exception: ", ex);
        }
        return null; //we should only get here if we hit the error case
    }

    public void Process_all_response(String responseString) {
        CommonUtils.LogMessage(TAG, "VR_interface: Process_all_response: " + responseString);
        try {
            String CommandCode = responseString.substring(1, 5);//he first is SOH: ignore it
            CommonUtils.LogMessage(TAG, "VR_interface: Process_all_response CommandCode: " + CommandCode);
            switch (CommandCode) {
                case "i" + Constants.VR_Inventory_Code: //It is sending the inventory report
            ...
            CommonUtils.LogMessage(TAG, "VR_interface: Process_all_response Exception: ", ex);
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //hub466 delivery
        //Process_all_response("\&&28E2\u0003");
...
//            TestChecksums();
//            Process_all_response("\&&953B\u0003");
//            Process_all_response("\u0001i20100200410001201100020744DB800044DAE00045072000420341ED0000000042831DB700000000&&EF32\u0003");
            Process_all_response("\u0001i20100200722130701100000745C9B80045C77000454C9000426601970000000042AA22D90000000002200000745433000453F80004446C0004253BD290000000042ACFAFD00000000&&E1D1\u0003");
        }
        //for all tanks
        ...
        try {
            ...
            CommonUtils.LogMessage(TAG, "onStartCommand Exception: ", ex);
        }
...
//            Integer a = Character.getNumericValue(c);
    ...
    private String FormatDate(String rawdatetime) {
        ...
        try {
            ...
            CommonUtils.LogMessage(TAG, "FormatDate Exception: ", ex);
        }
        return format_date;
    }
...
//                    mActivity.get().display.append(data);
                    ...
                    try {
                        ...
                        CommonUtils.LogMessage(TAG, "MyHandler handleMessage Exception: ", ex);
                    }
                    break;
...
//                            WriteVal(send_message);
    ...
    private void process_VR_Leak(String responseString) {
        try {
            ...
            CommonUtils.LogMessage(TAG, "VR_interface: process_VR_Leak Exception: ", ex);
        }
    }
...
/*        if (wait_time < 60 * 60 * 1000) {
            ...
            CommonUtils.LogMessage(TAG, " Do_next_VR_interface_Service Exception: ", e);
        }
    }
...
//                            WriteVal(send_message);
                ...
                CommonUtils.LogMessage(TAG, "USB_VR_connect2 doInBackground Exception: ", e);
            }
            AppConstants.RunningPoll = false;
    ...
    private String[] TransactionCompleteFunction_alarm(HashMap<String, String> CurrentTank) {
        ...
        try {
            ...
            CommonUtils.LogMessage("APFS33", "TransactionCompleteFunction_alarm Exception: ", ex);
        }
        return auths;
    }
    ...
    private void process_VR_Alarm(String responseString) {
        try {
            ...
            CommonUtils.LogMessage(TAG, "VR_interface: process_VR_Alarm Exception: ", ex);
        }
    }
    ...
    private ArrayList<HashMap<String, String>> parse_VR_response_alarm(String responseString) {
        ...
        try {
            ...
            CommonUtils.LogMessage(TAG, "VR_interface: parse_VR_response_alarm Exception: ", ex);
        }
